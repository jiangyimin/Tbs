...
namespace Tbs.Migrations
{
    ...
    partial class m1
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Tbs.DomainModels.PreWorker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("TenantId", "DepotId", "RouteCn");

                    b.ToTable("PreWorkers");
                });
            ...
            modelBuilder.Entity("Tbs.MultiTenancy.Tenant", b =>
                {
                    ...
                    b.Property<string>("WeixinCorpId")
                        .HasMaxLength(30);
