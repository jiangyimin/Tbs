    ...
    $(function() {
        ...
        $('#dg').datagrid({
            ...
            onSelect: function (index, row) {
                ...
                $('#dgRole').datagrid({
                    url: 'Roles/GetRoles/' + row.tenancyName
                })
            }
        });
       ...
       _$dg.datagrid({
            onSelect: function (index, row) {
                ...
                _roleService.getRolePermissionNames(tenancyName, row.id).done(function (data) {
        ...
        $('#dlg-tb').children('a[name="save"]').click(function (e) {
            ...
            _roleService.createRole(tenancyName, role).done(function () {
                _$dialog.dialog('close');
                _$dg.datagrid('reload'); 
            }).always(function() {
        ...
        $('#tb').children('a[name="grant"]').click(function (e) {
            ...
            if (rows.length > 0)
            {
                ...
                abp.ui.setBusy(_$dialog);
                _roleService.updateRolePermissions(tenancyName, {RoleId: id, GrantedPermissionNames: names}).done(function () {
